...
public final class ActivityDetailsBinding implements ViewBinding {
  ...
  private ActivityDetailsBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull Button showMapButton) {
  ...
  public static ActivityDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.show_map_button;
      Button showMapButton = ViewBindings.findChildViewById(rootView, id);
      if (showMapButton == null) {
        break missingId;
      }

      return new ActivityDetailsBinding((ConstraintLayout) rootView, main, showMapButton);
    }
